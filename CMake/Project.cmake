...
macro(set_project_with_parent_name_prefix PROJECT_NAME)
  ...
  project(${parent_name}_${project_name} ${ARGN})
...
macro(try_build_application)
    ...
    search_and_add_files_to_build_the_project()
    test_if_not_empty(source_files)
    add_executable(${PROJECT_NAME} ${source_files} ${header_files} ${ADDITIONAL_FILES})

    target_link_libraries(${PROJECT_NAME} ${ADDITIONAL_LIBRARIES})
    
    set_target_properties(${PROJECT_NAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${PROJECT_EXECUTABLE_OUTPUT_DIRECTORY})
    set_target_properties(${PROJECT_NAME} PROPERTIES RUNTIME_OUTPUT_NAME ${PROJECT_OUTPUT_NAME})
