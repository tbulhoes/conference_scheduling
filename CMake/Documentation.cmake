    ...
    if (DOXYGEN_FOUND)
    	...
    	add_custom_command(OUTPUT  ${DOCUMENTATION_OUTPUT}
    		               COMMAND ${DOCUMENTATION_COMMAND} 
                               DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}) #Issam Added This line and commented the following one. Needs to be double checked
        ...
        if (PDFLATEX_COMPILER AND LATEX_COMPILER)
            ...
            add_custom_target(${PROJECT_NAME}_doc_pdf DEPENDS "${DOCUMENTATION_OUTPUT_PDF}" )                   
            ...
            add_custom_target(${PROJECT_NAME}_package_doc_pdf
